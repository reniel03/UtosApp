<?php
// init_database.php - Initialize Railway database with required tables
// Run this once: visit http://your-app/init_database.php
...
CREATE TABLE IF NOT EXISTS `tasks` (
  ...
  CONSTRAINT `tasks_ibfk_1` FOREIGN KEY (`teacher_email`) REFERENCES `teachers` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
echo "<p>All required tables have been created in the Railway database.</p>";
$conn->close();
?>
