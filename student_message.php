...
$messages = [];
$query = "SELECT DISTINCT t.email as teacher_email,
                 t.first_name, t.middle_name, t.last_name, t.photo,
                 (SELECT COUNT(*) FROM messages m 
                  WHERE m.sender_email = t.email 
                  AND m.receiver_email = ? 
                  AND m.is_read = 0) as unread_count,
                 (SELECT message FROM messages m2 
                  WHERE ((m2.sender_email = ? AND m2.receiver_email = t.email) 
                      OR (m2.sender_email = t.email AND m2.receiver_email = ?))
                  ORDER BY m2.created_at DESC LIMIT 1) as last_message,
                 (SELECT created_at FROM messages m3 
                  WHERE ((m3.sender_email = ? AND m3.receiver_email = t.email) 
                      OR (m3.sender_email = t.email AND m3.receiver_email = ?))
                  ORDER BY m3.created_at DESC LIMIT 1) as last_message_time
          FROM student_todos st
          INNER JOIN tasks tk ON st.task_id = tk.id
          LEFT JOIN teachers t ON tk.teacher_email = t.email
          WHERE st.student_email = ?
          ORDER BY last_message_time DESC";

$stmt = $conn->prepare($query);
$stmt->bind_param('ssssss', $student_email, $student_email, $student_email, $student_email, $student_email, $student_email);
$stmt->execute();
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-header">
            ...
            <div class="page-subtitle">Stay connected with your teachers</div>
        </div>
        ...
        <div class="messages-container">
            ...
            <div id="chats-tab">
                <?php if (count($messages) > 0): ?>
                    <?php foreach ($messages as $index => $msg): ?>
                        <?php 
                            $teacher_name = trim(($msg['first_name'] ?? '') . ' ' . ($msg['middle_name'] ? $msg['middle_name'] . ' ' : '') . ($msg['last_name'] ?? ''));
                        ...
                        ?>
                        <div class="message-item" onclick="openChat('<?php echo $msg['teacher_email']; ?>')">
                            <div class="message-pin">📌</div>
                            <div class="message-content">
                                <div class="message-title"><?php echo htmlspecialchars($teacher_name); ?></div>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        <div class="empty-icon">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 120px; height: 120px;"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M7 8.5H12M7 12H15M9.68375 18H16.2C17.8802 18 18.7202 18 19.362 17.673C19.9265 17.3854 20.3854 16.9265 20.673 16.362C21 15.7202 21 14.8802 21 13.2V7.8C21 6.11984 21 5.27976 20.673 4.63803C20.3854 4.07354 19.9265 3.6146 19.362 3.32698C18.7202 3 17.8802 3 16.2 3H7.8C6.11984 3 5.27976 3 4.63803 3.32698C4.07354 3.6146 3.6146 4.07354 3.32698 4.63803C3 5.27976 3 6.11984 3 7.8V20.3355C3 20.8684 3 21.1348 3.10923 21.2716C3.20422 21.3906 3.34827 21.4599 3.50054 21.4597C3.67563 21.4595 3.88367 21.2931 4.29976 20.9602L6.68521 19.0518C7.17252 18.662 7.41617 18.4671 7.68749 18.3285C7.9282 18.2055 8.18443 18.1156 8.44921 18.0613C8.74767 18 9.0597 18 9.68375 18Z" stroke="#ff0000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                        </div>
                        <div class="empty-title">No Messages Yet</div>
                        <div class="empty-text">Start a conversation with your teachers</div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div id="notifications-tab" style="display: none;">
                <div class="empty-state">
                    <div class="empty-icon">
                        <svg fill="#ff0000" viewBox="0 0 24 24" id="notification-copy" xmlns="http://www.w3.org/2000/svg" class="icon line" style="width: 120px; height: 120px;"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path id="primary" d="M19.38,14.38a2.12,2.12,0,0,1,.62,1.5h0A2.12,2.12,0,0,1,17.88,18H6.12A2.12,2.12,0,0,1,4,15.88H4a2.12,2.12,0,0,1,.62-1.5L6,13V9a6,6,0,0,1,6-6h0a6,6,0,0,1,6,6v4ZM15,18H9a3,3,0,0,0,3,3h0A3,3,0,0,0,15,18Z" style="fill: none; stroke: #ff0000; stroke-linecap: round; stroke-linejoin: round; stroke-width: 1.5;"></path></g></svg>
                    </div>
    ...
    <nav class="bottom-nav">
        ...
        <a href="student_message.php" class="bottom-nav-item active" title="Messages">
            <span class="bottom-nav-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <script>
        ...
        function openChat(teacherEmail) {
            Swal.fire({
                title: 'Message Feature',
                text: 'Full messaging system coming soon!',
                icon: 'info',
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const currentPage = 'student_message.php';
